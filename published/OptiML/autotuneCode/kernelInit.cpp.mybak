...
cppDeliteArraydouble *x356 = new cppDeliteArraydouble(x355, resourceInfo.thread_id);
cppDeliteArraydouble *x357 = x356;
cppDenseMatrixDouble *x358 = new cppDenseMatrixDouble(x353,x354,x357);
int32_t x359 = x358->_numRows;
int32_t x360 = x358->_numCols;
cppDeliteArraydouble *x361 = x358->_data;
cppDenseMatrixDouble *x362 = new cppDenseMatrixDouble(x359,x360,x361);
...
cppDeliteArraydouble *x368 = new cppDeliteArraydouble(x367, resourceInfo.thread_id);
cppDeliteArraydouble *x369 = x368;
cppDenseMatrixDouble *x370 = new cppDenseMatrixDouble(x365,x366,x369);
int32_t x371 = x370->_numRows;
int32_t x372 = x370->_numCols;
cppDeliteArraydouble *x373 = x370->_data;
cppDenseMatrixDouble *x374 = new cppDenseMatrixDouble(x371,x372,x373);
...
cppDeliteArraydouble *x380 = new cppDeliteArraydouble(x379, resourceInfo.thread_id);
cppDeliteArraydouble *x381 = x380;
cppDenseMatrixDouble *x382 = new cppDenseMatrixDouble(x377,x378,x381);
int32_t x383 = x382->_numRows;
int32_t x384 = x382->_numCols;
cppDeliteArraydouble *x385 = x382->_data;
cppDenseMatrixDouble *x386 = new cppDenseMatrixDouble(x383,x384,x385);
